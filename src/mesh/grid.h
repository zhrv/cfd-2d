...
public:
	...
	int    nCountEx;	//количество nodes с фиктивными ячйками.
	int    cCountEx;  //количество ячеек(cells) с фиктивными ячйками.
	int    eCountEx;  //количество ребер(edges) с фиктивными ячйками.
